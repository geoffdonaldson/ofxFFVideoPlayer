...
//	virtual void				previousFrame();
    ...
    void            setPixConvType(PIX_CONVERSION_TYPE type);
    int             getPixConvType();
private:
    ...
    vector<msa::OpenCLBuffer> yuvImage;
    vector<long>              yuvImageLineSize;
    msa::OpenCLKernel       *openCLkernel;
    
    PIX_CONVERSION_TYPE     pix_conv_type;
};
